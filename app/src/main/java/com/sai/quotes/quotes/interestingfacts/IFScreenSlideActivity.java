 ...
 *
 * @see IFScreenSlidePageFragment
 */
public class IFScreenSlideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getting details from recycleradapterquotes
...
//        String selectedValue = sharedpreferences.getString("arrname", "");
...
*/
    ...
    /**
     * A simple pager adapter that represents 5 {@link IFScreenSlidePageFragment} objects, in
     * sequence.
     */
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            return IFScreenSlidePageFragment.create(position);
        }
